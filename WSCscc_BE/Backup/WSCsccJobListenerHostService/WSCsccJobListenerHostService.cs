...
{
	public class WSCsccJobListenerHostServiceMain : System.ServiceProcess.ServiceBase
	{
		/// <summary> 
		...
		public WSCsccJobListenerHostServiceMain()
		{
		...
		static void Main()
		{
			...
			//
			ServicesToRun = new System.ServiceProcess.ServiceBase[] { new WSCsccJobListenerHostServiceMain() };
		...
		private void InitializeComponent()
		{
			...
			this.ServiceName = "WSCsccJob Listener Host Service";
		}
