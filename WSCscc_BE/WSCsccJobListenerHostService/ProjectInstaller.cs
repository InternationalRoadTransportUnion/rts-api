...
namespace WSCsccJobListenerHostService
{
	/// <summary>
	...
	public class ProjectInstaller : System.Configuration.Install.Installer
	{
		...
		private void InitializeComponent()
		{
			...
			// serviceInstaller1
			// 
			this.serviceInstaller1.DisplayName = "WSCscc Job Listener Service";
			this.serviceInstaller1.ServiceName = "WSCsccJob Listener Host Service";
			// 
			// ProjectInstaller
			// 
