...
xcopy /e /y "WSST_BE\WSST_Processor\bin\*.*" "RTS\WSST_In"
xcopy /e /y "WSST_BE\WSST_FileRcvrHostService\bin\*.*" "RTS\WSST_Ex"
xcopy /e /y "WSST_BE\WSST_FileReceiver\bin\*.*" "RTS\WSST_Ex"
...
xcopy /e /y "WSRQ_BE\WSRQ_QueryProcessor\bin\*.*" "RTS\WSRQ"
...
xcopy /e /y "WSRE_BE\WSRE_Processor\bin\*.*" "RTS\WSST_In"
xcopy /e /y "WSRE_BE\WSRE_FileRcvrHostService\bin\*.*" "RTS\WSST_Ex"
xcopy /e /y "WSRE_BE\WSRE_FileReceiver\bin\*.*" "RTS\WSST_Ex"
