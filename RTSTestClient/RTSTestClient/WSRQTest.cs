...
{
	/// <summary>
	/// Summary description for WSRQTest.
	/// </summary>
	public class WSRQTest : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.txtIEV = new System.Windows.Forms.TextBox();
            ...
            // groupBox1
            // 
            this.groupBox1.Controls.Add(this.txtIEV);
            ...
            // txtSubsID
            // 
            this.txtSubsID.Location = new System.Drawing.Point(143, 80);
            ...
            // btnSelectFile
            // 
            this.btnSelectFile.Location = new System.Drawing.Point(472, 20);
            ...
            this.label2.Text = "Sender_MessageID";
            // 
            // txtQueryID
            // 
            this.txtQueryID.Location = new System.Drawing.Point(143, 45);
            ...
            // cmdCall
            // 
            this.cmdCall.Location = new System.Drawing.Point(512, 16);
            ...
            // 
            this.txtOriginalQueryFile.Location = new System.Drawing.Point(143, 16);
            ...
            this.txtOriginalQueryFile.Text = "o:\\bin\\WSRQuery.xml";
            // 
            // groupBox2
            // 
            ...
            this.groupBox2.Size = new System.Drawing.Size(608, 256);
            ...
            this.txtOutPut.Size = new System.Drawing.Size(602, 237);
            this.txtOutPut.TabIndex = 0;
            this.txtOutPut.Text = "-";
            // 
            // txtIEV
            // 
            this.txtIEV.Location = new System.Drawing.Point(143, 110);
            this.txtIEV.Name = "txtIEV";
            this.txtIEV.Size = new System.Drawing.Size(312, 20);
            this.txtIEV.TabIndex = 12;
            this.txtIEV.Text = "1.0.0";
            // 
            // label4
            // 
            ...
            this.label4.Text = "Information Exchange Version";
            // 
            // WSRQTest
            // 
            ...
            this.Name = "WSRQTest";
            this.Text = "WSRQ WS Tester";
            this.Load += new System.EventHandler(this.WSRQTest_Load);
		...
		private void cmdCall_Click(object sender, System.EventArgs e)
		{
			...
			WSRQ.ReconciliationQuery rq = new WSRQ.ReconciliationQuery();
			...
			try
			{
				...
				fileName =txtOriginalQueryFile.Text+".3DesEncKey.bin";
                rq.ESessionKey = GetFileContents(fileName);
            }
            ...
            try
			{
                ...
                rq.MessageTag=GetFileString( txtOriginalQueryFile.Text+".ThumbPrint.txt");
            }
            catch(IOException ioex)
            {
                txtOutPut.Text+= "\r\n  IO Exception: Check log file for details: " + ioex.Message;
            ...
            try
			{
                ...
                rq.ReconciliationQueryData = GetFileContents(fileName);
            }
            catch(IOException ioex)
            {
                txtOutPut.Text+= "\r\n  IO Exception: Check log file for details: " + ioex.Message;
			...
			rq.SubscriberID = txtSubsID.Text.Trim();
            rq.Sender_MessageID = txtQueryID.Text.Trim();
            rq.Information_Exchange_Version = txtIEV.Text.Trim();
			...
			WSRQ.ReconciliationQueryServiceClass  WSRQClass= new WSRQ.ReconciliationQueryServiceClass();
            WSRQClass.Timeout = 530000; 

            WSRQ.ReconciliationResponse rr;
			try
			{
                rr = WSRQClass.WSRQ(rq);
			...
			txtOutPut.Text += "\r\n The return code is :" + rr.ReturnCode.ToString();
			//txtOutPut.Text += "\r\n The Query ID is :" + rr.Query_ID.ToString();
			txtOutPut.Text += "\r\n The Message Tag is :" +  rr.MessageTag ;
			...
			sqlSelect.Parameters["@KeyID"].Value= rr.MessageTag;
			...
			if (bFound==false)
			{
				txtOutPut.Text += "\r\n No key found in IRU_ENCRYPTION_KEYS table corresponding to " + rr.MessageTag;
				return;
			...
			try
			{
				decoutput = ic.Decrypt(rr.ESessionKey ,"RSA",ht2);
			}
			...
			try
			{
				decoutputMsg = ic.Decrypt(rr.ReconciliationRequestData,"3DES",ht3);
			}
			catch  (Exception crypEx)
			{
				MessageBox.Show("Crypt Exception: Check log file for details: " + crypEx.Message);
...
*/
		...
		private void WSRQTest_Load(object sender, System.EventArgs e)
		{
