 ...
 */
		...
		public void GenerateCertificate(string CertPath, string EMail, string Subscriber, DateTime ExpiryDate, out string StandardOutput, out string CommandLine)
		{
			...
			string keyContainer = "IRUKey" +  DateTime.Now.ToString("yyyyMMddHHmmss");

			CommandLine= " -r -pe -sk  " + keyContainer   +   " -n \"CN= IRU.org RTS, OU=Subscriber :" + Subscriber + " , O=IRU.org, E=" + EMail + "\"  -sr localmachine -ss IRUTEST -e " + ExpiryDate.ToString("MM/dd/yyyy") + "  "  + CertPath; 
