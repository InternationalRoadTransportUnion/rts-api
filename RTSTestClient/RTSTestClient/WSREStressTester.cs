...
namespace RTSTestClient
{
	...
	/// </summary>
	public class WSREStressTester : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "WSSTStressTester";
			this.Text = "WSSTStressTester";
		...
		private void linkLabel1_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			try
			{
				if(ofd.FileNames.Length >0)
				{
					...
					WSSTStressTest tcs = new WSSTStressTest();
		...
		private void linkLabel2_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			#region Select folder and generate XML message - Not in Use for WSST
		...
		private void linkLabel3_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			try
			{
				...
				foreach (string aFileQID in m_aStressXML)
				{
					...
					CallWS(aFileQID,m_thumbPrint,aFileQID,"FCS","ASMAP");			 
