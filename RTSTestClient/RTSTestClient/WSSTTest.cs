...
namespace RTSTestClient
{
	...
	/// </summary>
	public class WSSTTest : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Copy To ID";
			// 
			// txtCopyToID
			// 
            //this.txtCopyToID.Location = new System.Drawing.Point(120, 80);
            //this.txtCopyToID.MaxLength = 300;
            //this.txtCopyToID.Name = "txtCopyToID";
            //this.txtCopyToID.Size = new System.Drawing.Size(312, 20);
            //this.txtCopyToID.TabIndex = 9;
            //this.txtCopyToID.Text = "ASMAP";
			// 
			// btnSelectFile
			// 
			...
			// txtSubscriberID
			// 
			this.txtSubscriberID.Location = new System.Drawing.Point(120, 112);
		...
		{
			 WSST.SafeTIRUploadParams su = new WSST.SafeTIRUploadParams();
			...
			try
			{
                //TODO: For testing for errors
                su.ESessionKey = new byte[0];
				tr= uploadClass.WSST(su);
			...
			txtOutPut.Text += "\r\n The Message ID is :" + tr.Sender_MessageID.ToString();
