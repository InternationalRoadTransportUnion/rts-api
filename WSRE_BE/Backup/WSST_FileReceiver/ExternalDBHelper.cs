...
{
	/// <summary>
	/// This class is used by WSST_FileReceiver to update the WSST_Exernal_Log table in the WSST_EXTERNAL_DB
	/// </summary>
...
//"SafeTIRUploadData","COPY_TO_ID","SENDER_TCP_IP_ADDRESS","ROW_CREATED_TIME","SENDER_MESSAGEID","RETURN_CODE","RETURN_CODE_DESCRIPTION"
		private static string[] m_aLogRecord = new string[]{"SAFETIR_MESSAGE_IN_ID" ,"SESSION_KEY_USED_ENCRYPTED_IN" ,"ENCRYPTION_KEY_ID","SUBSCRIBER_ID","SafeTIRUploadData","COPY_TO_ID","SENDER_TCP_IP_ADDRESS","ROW_CREATED_TIME","SENDER_MESSAGEID"};
		...
		WSST_EXTERNAL_LOG_STRUCT m_WSST_EXTERNAL_LOG_STRUCT;

		/// <summary>
		/// Stores references to ExternalIDBHElper and the main WSST_EXTERNAL_LOG_STRUCT. 
		/// These are used in the member variables.
		/// </summary>
		/// <param name="iExtDBHelper">Reference to External DB IDBHelper</param>
		/// <param name="ExtLogStruct">Reference to WSST_EXTERNAL_LOG_STRUCT in WSST_FileReceiver</param>
		public ExternalDBHelper(IDBHelper iExtDBHelper, WSST_EXTERNAL_LOG_STRUCT ExtLogStruct)
		{
			m_ExtIDBHelper = iExtDBHelper;
			m_WSST_EXTERNAL_LOG_STRUCT = ExtLogStruct;
		}
	...
	public class WSST_EXTERNAL_LOG_STRUCT
	{
		...
		public 	byte[]	SafeTIRUploadData	;	//Nullable	-16
		public 	string	COPY_TO_ID	;	//Nullable	-510
