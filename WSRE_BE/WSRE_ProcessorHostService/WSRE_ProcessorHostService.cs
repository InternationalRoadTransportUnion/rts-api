...
namespace WSRE_ProcessorHostService
{
	public class WSRE_ProcessorHostServiceMain : System.ServiceProcess.ServiceBase
	{
		/// <summary> 
		...
		public WSRE_ProcessorHostServiceMain()
		{
		...
		static void Main()
		{
			...
			//
			ServicesToRun = new System.ServiceProcess.ServiceBase[] { new WSRE_ProcessorHostServiceMain() };
		...
		private void InitializeComponent()
		{
			...
			this.ServiceName = "WSRE_Processor Host Service";
		}
