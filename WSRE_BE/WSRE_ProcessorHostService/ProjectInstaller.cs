...
namespace WSST_ProcessorHostService
{
	/// <summary>
	...
	public class ProjectInstaller : System.Configuration.Install.Installer
	{
		...
		private void InitializeComponent()
		{
			...
			// serviceInstaller1
			// 
			this.serviceInstaller1.DisplayName = "WSRE Processor Host Service";
			this.serviceInstaller1.ServiceName = "WSRE_Processor Host Service";
			// 
			// ProjectInstaller
			// 
