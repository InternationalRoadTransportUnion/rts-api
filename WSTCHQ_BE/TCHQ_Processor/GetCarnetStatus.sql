	...
	BEGIN  
		...
		BEGIN 
			...
			BEGIN 
				...
				FROM dbo.CAR_CUR_ISSUE_TABLE with (nolock) INNER JOIN  
				dbo.CAR_CUR_SYS_ASSOC_DETAILS with (nolock) ON CAR_CUR_ISSUE_TABLE.C_I_ASSOCIATION = CAR_CUR_SYS_ASSOC_DETAILS.C_XST_ASSOCIATION  
