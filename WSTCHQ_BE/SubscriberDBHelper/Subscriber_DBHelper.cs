...
namespace IRU.RTS.CommonComponents
{
	...
	public class Subscriber_DBHelper
	{
			...
			out String CopyToID, out string CopyToAddress)
		{
			...
			*/
            strBuilder.Append("FROM dbo.WS_SUBSCRIBER_SERVICES INNER JOIN ");
            strBuilder.Append("dbo.WS_SUBSCRIBER_SERVICE_METHOD ON WS_SUBSCRIBER_SERVICES.SERVICE_ID = WS_SUBSCRIBER_SERVICE_METHOD.SERVICE_ID AND  ");
			strBuilder.Append("WS_SUBSCRIBER_SERVICES.SUBSCRIBER_ID = WS_SUBSCRIBER_SERVICE_METHOD.SUBSCRIBER_ID INNER JOIN ");
            strBuilder.Append("dbo.WS_SUBSCRIBER ON WS_SUBSCRIBER_SERVICES.SUBSCRIBER_ID = WS_SUBSCRIBER.SUBSCRIBER_ID LEFT OUTER JOIN ");
            strBuilder.Append("dbo.COPY_TO_URLS ON WS_SUBSCRIBER.SUBSCRIBER_ID = COPY_TO_URLS.COPY_TO_ID ");
