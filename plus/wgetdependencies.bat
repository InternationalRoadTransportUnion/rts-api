...
set COMMON_WCF_VERSION=1.6.11.0
set COMMON_ENTLIB_VERSION=1.1.1.0
set RTSDOTNET_CLIENT_VERSION=1.6.13
set COMMON_IRU_SCHEMAS_VERSION=1.8
set TIRPLUS_MODEL_VERSION=1.1
set WGET_PARAMS=--no-proxy

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/wcf/security/wss/%COMMON_WCF_VERSION%/wss-%COMMON_WCF_VERSION%-3.5.dll
move /y wss-%COMMON_WCF_VERSION%-3.5.dll Dependencies\IRU.Common.WCF.Security.WSS.dll

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/wcf/wsdl/%COMMON_WCF_VERSION%/wsdl-%COMMON_WCF_VERSION%-3.5.dll
move /y wsdl-%COMMON_WCF_VERSION%-3.5.dll Dependencies\IRU.Common.WCF.Wsdl.dll

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/wcf/behaviors/%COMMON_WCF_VERSION%/behaviors-%COMMON_WCF_VERSION%-3.5.dll
move /y behaviors-%COMMON_WCF_VERSION%-3.5.dll Dependencies\IRU.Common.WCF.Behaviors.dll

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/entlib/%COMMON_ENTLIB_VERSION%/entlib-%COMMON_ENTLIB_VERSION%-3.5.dll
move /y entlib-%COMMON_ENTLIB_VERSION%-3.5.dll Dependencies\IRU.Common.EnterpriseLibrary.dll

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/rts/classic/rtsdotnet-client/%RTSDOTNET_CLIENT_VERSION%/rtsdotnet-client-%RTSDOTNET_CLIENT_VERSION%-3.5.dll
move /y rtsdotnet-client-%RTSDOTNET_CLIENT_VERSION%-3.5.dll Dependencies\RTSDotNETClient.dll

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-iso-3166-1-alpha-3.xsd
...
wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-tir-actor.xsd
...
wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-tir-carnet.xsd
...
wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd
move /y iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd IRU.RTS.WS\CarnetService\IRU.RTS.WS.CarnetService.Interface\CarnetService-1\iru-guarantee-1.xsd

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/tirplus/tirplus-model/%TIRPLUS_MODEL_VERSION%/tirplus-model-%TIRPLUS_MODEL_VERSION%-voucher.xsd
move /y tirplus-model-%TIRPLUS_MODEL_VERSION%-voucher.xsd IRU.RTS.WS\CarnetService\IRU.RTS.WS.CarnetService.Interface\CarnetService-1\tirplus-voucher-1.xsd
...
wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd
move /y iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd IRU.RTS.WS\TerminationService\IRU.RTS.WS.TerminationService.Interface\TerminationService-1\iru-guarantee-1.xsd

wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/tirplus/tirplus-model/%TIRPLUS_MODEL_VERSION%/tirplus-model-%TIRPLUS_MODEL_VERSION%-voucher.xsd
move /y tirplus-model-%TIRPLUS_MODEL_VERSION%-voucher.xsd IRU.RTS.WS\TerminationService\IRU.RTS.WS.TerminationService.Interface\TerminationService-1\tirplus-voucher-1.xsd
...
wget %WGET_PARAMS% %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/common/iru-schemas/%COMMON_IRU_SCHEMAS_VERSION%/iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd
move /y iru-schemas-%COMMON_IRU_SCHEMAS_VERSION%-guarantee.xsd IRU.RTS.WS\VoucherService\IRU.RTS.WS.VoucherService.Interface\VoucherService-1\iru-guarantee-1.xsd
