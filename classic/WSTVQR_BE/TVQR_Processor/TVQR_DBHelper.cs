...
{
	/// <summary>
	/// Wraps all calls to TVQRDB.
	/// </summary>
	public class TVQR_DBHelper
	{
		private IDBHelper m_requestHelper;
		/// <summary>
		/// Initialize the TVQR_DB instance  of IDBHelper
		/// </summary>
		/// <param name="requestHelper"></param>
		public TVQR_DBHelper(/*IDBHelper subscriberHelper,*/IDBHelper requestHelper )
		{
...
//			String tirCarnetNumber, String senderQueryID, Int32 senderAuthenticated, DateTime rowCreationTime)
		...
		/// <summary>
		/// Log Initial Request in TVQR_REQUEST_LOG, as soon as the query is recieved 
