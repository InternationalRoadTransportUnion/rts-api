...
{
	public class RTSAlertHostService : System.ServiceProcess.ServiceBase
	{
		/// <summary> 
        ...
        static void Main(string[] args)
		{
			...
			//
			//   ServicesToRun = new System.ServiceProcess.ServiceBase[] {new RTSAlertHostService(), new MySecondUserService()};
			//
		...
		private void InitializeComponent()
		{
			...
			this.ServiceName = "RTS Alert and Reporting Host Service";
		}
