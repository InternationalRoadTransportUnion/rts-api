...
{
	/// <summary>
	/// Summary description for WSRQSampleMessageGenerator.
	/// </summary>

	public class WSRESampleMessageGenerator : System.Windows.Forms.Form
    {
		...
		public WSRESampleMessageGenerator()
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            // 
            // WSRESampleMessageGenerator
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(512, 88);
            this.Controls.Add(this.groupBox1);
            this.Name = "WSRESampleMessageGenerator";
		...
		private void cmdGenerateQuery_Click(object sender, System.EventArgs e)
		{
        	...
        	//read the orginal file
				StreamReader sr = new StreamReader(txtInFile.Text,System.Text.Encoding.Unicode);
				try
				{
					sQueryXML = sr.ReadToEnd();
                    sQueryXML= sQueryXML.Trim();
