...
set COMMON_WCF_VERSION=1.6.7.0
set COMMON_ENTLIB_VERSION=1.0.3.0
set RTSDOTNET_CLIENT_VERSION=1.2.2
...
wget %REPO_LIBS_RELEASE_LOCAL_URL%/org/iru/rts/rtsdotnet-client/%RTSDOTNET_CLIENT_VERSION%/rtsdotnet-client-%RTSDOTNET_CLIENT_VERSION%-3.5.dll
