...
set COMMON_WCF_VERSION=1.5.3.0
set COMMON_ENTLIB_VERSION=1.0.1.0
set RTSDOTNET_CLIENT_VERSION=1.1.0.0
set COMMON_IRU_SCHEMAS_VERSION=1.3

wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/security/wss/%COMMON_WCF_VERSION%/wss-%COMMON_WCF_VERSION%-3.5.dll
move /y wss-%COMMON_WCF_VERSION%-3.5.dll Dependencies\IRU.Common.WCF.Security.WSS.dll

wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/wsdl/%COMMON_WCF_VERSION%/wsdl-%COMMON_WCF_VERSION%-3.5.dll
move /y wsdl-%COMMON_WCF_VERSION%-3.5.dll Dependencies\IRU.Common.WCF.Wsdl.dll

wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/behaviors/%COMMON_WCF_VERSION%/behaviors-%COMMON_WCF_VERSION%-3.5.dll
