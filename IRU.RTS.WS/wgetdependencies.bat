...
wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/security/wss/1.3.4.0/wss-1.3.4.0-3.5.dll
move /y wss-1.3.4.0-3.5.dll Dependencies\IRU.Common.WCF.Security.WSS.dll

wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/wsdl/1.3.4.0/wsdl-1.3.4.0-3.5.dll
move /y wsdl-1.3.4.0-3.5.dll Dependencies\IRU.Common.WCF.Wsdl.dll

wget http://apps.charybdis.iruworld.org/swf/artifactory/libs-release-local/org/iru/common/wcf/behaviors/1.3.4.0/behaviors-1.3.4.0-3.5.dll
move /y behaviors-1.3.4.0-3.5.dll Dependencies\IRU.Common.WCF.Behaviors.dll
