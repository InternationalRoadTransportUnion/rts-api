...
{
	/// <summary>
	/// Summary description for StructToTable.
	/// </summary>
	public class StructToTable
	{
		...
		private void PopulateParameters (object DataStruct, SqlCommand SqlCommandToPopulate, string [] AFieldNames)
		{
			...
			for (fieldCounter =0 ; fieldCounter< AFieldNames.Length;fieldCounter++)
			{
				...
				{
					case  ("STRUCT_TO_TABLE.NullableInt"):
					{
						NullableInt nValOut;
					...
					case  ("STRUCT_TO_TABLE.NullableDouble" ):
					{
					...
					case("System.Double"):
					{
						...
						break;				
						#region datetime
					case  ("STRUCT_TO_TABLE.NullableDateTime"):
					{
					...
					case("System.String"):
					{
						...
						#region nullableBool
					case  ("STRUCT_TO_TABLE.NullableBool"):
					{
