...
SELECT [SUBSCRIBER_ID]
  ...
  FROM [WS_SUBSCRIBER_DB].[dbo].[WS_SUBSCRIBER_SERVICE_METHOD]
			 ...
			 */
			string sMethodsSQL = "SELECT [METHOD_ID] FROM [WS_SUBSCRIBER_SERVICE_METHOD] WHERE SUBSCRIBER_ID = @SUBSCRIBER_ID AND SERVICE_ID=@SERVICE_ID";
...
SELECT [SUBSCRIBER_ID]
  ...
  FROM [WS_SUBSCRIBER_DB].[dbo].[WS_SUBSCRIBER_SERVICE_METHOD]
			...
			string sServicesSQL = "SELECT [METHOD_DESCRIPTION], [ACTIVE]  " +
				 " FROM [WS_SUBSCRIBER_SERVICE_METHOD] WHERE SUBSCRIBER_ID = @SUBSCRIBER_ID AND SERVICE_ID=@SERVICE_ID AND METHOD_ID = @METHOD_ID";
		...
		private void btnUpdate_Click(object sender, System.EventArgs e)
		{
			...
			string sUpdateSQL = "UPDATE WS_SUBSCRIBER_SERVICE_METHOD "
		...
		private void btnAdd_Click(object sender, System.EventArgs e)
		{
			...
			string sInsSvcMthSQL = "INSERT WS_SUBSCRIBER_SERVICE_METHOD "
