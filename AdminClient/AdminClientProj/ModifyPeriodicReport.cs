	...
	public class ModifyPeriodicReport : System.Windows.Forms.Form
	{
		...
		private void InsertReportToDB(CommonDBHelper dbHelper)
		{
			...
			#region connect to DB and update
                ...
                string sInsertReportMainSQL = "INSERT INTO dbo.PERIODIC_REPORT (REPORT_ID, SERVICE_ID,LAST_EXECUTION_TIME,NEXT_SCHEDULE_ID, NEXT_EXECUTION_TIME, LAST_UPDATE_USERID,LAST_UPDATE_TIME) VALUES (@REPORT_ID, @SERVICE_ID,@LAST_EXECUTION_TIME,@NEXT_SCHEDULE_ID, @NEXT_EXECUTION_TIME, @LAST_UPDATE_USERID,getdate())";

                string sInsertReportSQLSQL = "INSERT INTO dbo.PERIODIC_REPORT_SQL (REPORT_ID, QUERY_SQL, QUERY_DESCRIPTION,LAST_UPDATE_USERID,LAST_UPDATE_TIME) VALUES (@REPORT_ID,@QUERY_SQL,@QUERY_DESCRIPTION,@LAST_UPDATE_USERID,getdate())";

                string sInsertReportScheduleSQL = "INSERT INTO dbo.PERIODIC_REPORT_SCHEDULE (REPORT_ID,SCHEDULE_ID,SCHEDULE_DAY,SCHEDULE_TIME,NEXT_SCHEDULE_ID,LAST_UPDATE_USERID,LAST_UPDATE_TIME) VALUES (@REPORT_ID,@SCHEDULE_ID,@SCHEDULE_DAY,@SCHEDULE_TIME,@NEXT_SCHEDULE_ID,@LAST_UPDATE_USERID,getdate())";
		...
		private void btnSvcSelect_Click(object sender, System.EventArgs e)
		{
            ...
            string sSelectReportsSQL = "SELECT REPORT_ID FROM dbo.PERIODIC_REPORT WHERE SERVICE_ID=@SERVICE_ID";
		...
		private void btnRepSelect_Click(object sender, System.EventArgs e)
		{
            ...
            string sReportSelectSQL = "SELECT [LAST_EXECUTION_TIME] ,[LAST_UPDATE_USERID]       ,[LAST_UPDATE_TIME]  FROM dbo.PERIODIC_REPORT " + 
				" WHERE REPORT_ID = @REPORT_ID";


            string sReportSelectSQLSQL = "SELECT [QUERY_SQL]      ,[QUERY_DESCRIPTION] FROM dbo.[PERIODIC_REPORT_SQL] " + 
				" WHERE REPORT_ID = @REPORT_ID";


            string sReportSelectSchSQL = "SELECT [SCHEDULE_DAY]      ,[SCHEDULE_TIME] FROM dbo.[PERIODIC_REPORT_SCHEDULE] " +
		...
		private void DeletePeriodicReport(CommonDBHelper dbHelper, int ReportID)
		{
            ...
            string sReportDeleteSQL = "DELETE dbo.PERIODIC_REPORT " + 
				" WHERE REPORT_ID = @REPORT_ID";


            string sReportDeleteSQLSQL = "DELETE dbo.[PERIODIC_REPORT_SQL] " + 
				" WHERE REPORT_ID = @REPORT_ID";


            string sReportDeleteSchSQL = "DELETE dbo.[PERIODIC_REPORT_SCHEDULE] " +
				" WHERE REPORT_ID = @REPORT_ID";
