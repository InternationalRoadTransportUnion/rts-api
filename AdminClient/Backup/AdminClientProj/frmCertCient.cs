...
namespace IRU.RTS.AdminClient
{
	...
	public class frmCertClient : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// dtExpiryDate
			// 
			this.dtExpiryDate.Location = new System.Drawing.Point(144, 56);
		...
		private void cmdGenerate_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				cg.GenerateCertificate(txtCertPath.Text,txtIssuerEmail.Text,cboSubscriber.Text, dtExpiryDate.Value, out standardOutPut, out commandLine, out dtGenerated, out CertPath);
			}
