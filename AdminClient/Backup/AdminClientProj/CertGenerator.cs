 ...
 */
		...
		public void GenerateCertificate(string CertFolder, string EMail, string Subscriber, DateTime ExpiryDate, out string StandardOutput, out string CommandLine, out DateTime dtGenerated, out string CertPath)
		{
			...
			CommandLine= " -r -pe -len 1024 -sk  " + keyContainer   +   " -n \"CN= IRU.org RTS, OU=Subscriber :" + Subscriber + " , O=IRU.org, E=" + EMail + "\"  -sr localmachine -ss IRUTEST -e " + ExpiryDate.ToString("MM'/'dd'/'yyyy") + "  "  + CertPath; 
