...
namespace IRU.RTS.AdminClient
{
	...
	public class ManageAlerts : System.Windows.Forms.Form
	{
		...
		private void btnSvcSelect_Click(object sender, System.EventArgs e)
		{
			...
			string sSelectFaultSQL= "SELECT FAULT_TYPE, ALERT_DESCRIPTION FROM ALERT_TRACK WHERE SERVICE_ID=@SERVICE_ID ORDER BY FAULT_TYPE";
		...
		private void btnRepSelect_Click(object sender, System.EventArgs e)
		{
			...
			string sFaultSelectSQL = "SELECT [THRESHOLD_QUANTITY]      ,[SQL_QUERY]       ,[NEXT_TIME_TO_RUN]      ,[LAST_COUNT]      ,[LAST_RUN_TIME]       ,[NO_FAULT_DELAY]      ,[FAULTS_NO_ALERT_DELAY]      ,[ALERT_DELAY]       ,[ALERT_DESCRIPTION]      ,[LAST_UPDATE_USERID]      ,[LAST_UPDATE_TIME]   FROM [ALERT_TRACK]" + 
		...
		private void DeleteFaultAlert(CommonDBHelper dbHelper, int ReportID)
		{
			...
			string sReportDeleteSQL = "DELETE ALERT_TRACK " + 
		...
		private void btnUpdate_Click(object sender, System.EventArgs e)
		{
			...
			string sUpdateFaultMainSQL= "UPDATE [ALERT_TRACK] SET [THRESHOLD_QUANTITY]=@THRESHOLD_QUANTITY,  [SQL_QUERY]=@SQL_QUERY    ,[NO_FAULT_DELAY]=@NO_FAULT_DELAY ,[FAULTS_NO_ALERT_DELAY]=@FAULTS_NO_ALERT_DELAY ,[ALERT_DELAY]=@ALERT_DELAY  ,[ALERT_DESCRIPTION]=@ALERT_DESCRIPTION ,[LAST_UPDATE_USERID]=@LAST_UPDATE_USERID ,[LAST_UPDATE_TIME]=getdate() " +
				" WHERE SERVICE_ID=@SERVICE_ID AND FAULT_TYPE=@FAULT_TYPE";
		...
		private void btnAdd_Click(object sender, System.EventArgs e)
		{
			...
			string sInsertFaultMainSQL= "INSERT INTO [ALERT_TRACK] ([SERVICE_ID]  ,[FAULT_TYPE]  ,[THRESHOLD_QUANTITY]  ,[SQL_QUERY]  ,[NEXT_TIME_TO_RUN] ,[LAST_COUNT] ,[LAST_RUN_TIME]  ,[NO_FAULT_DELAY] ,[FAULTS_NO_ALERT_DELAY] ,[ALERT_DELAY]  ,[ALERT_DESCRIPTION] ,[LAST_UPDATE_USERID] ,[LAST_UPDATE_TIME]) " + 
